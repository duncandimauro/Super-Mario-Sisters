...
public:
	...
	Block(int pos_x, int pos_y, BlockType goodie, int imageID, StudentWorld* sw)
		: Actor(sw, imageID, pos_x* SPRITE_WIDTH, pos_y* SPRITE_HEIGHT, 0, 2, 1, false, false),
...
{
public:
	Enemy(StudentWorld* sw, int imageID, int pos_x, int pos_y, bool stompable)
		: Actor(sw, imageID, pos_x* SPRITE_WIDTH, pos_y* SPRITE_HEIGHT, 180 * (rand() % 2), 0, 1, true, true), m_stompable(stompable) {}
...
public:
	Koopa(int pos_x, int pos_y, StudentWorld* sw)
		: Enemy(sw, IID_KOOPA, pos_x, pos_y, true) {}
...
public:
	Goomba(int pos_x, int pos_y, StudentWorld* sw)
		: Enemy(sw, IID_GOOMBA, pos_x, pos_y, true) {}
};
...
public:
	Piranha(int pos_x, int pos_y, StudentWorld* sw)
		: Enemy(sw, IID_PIRANHA, pos_x, pos_y, false), m_fire_delay(0) {}

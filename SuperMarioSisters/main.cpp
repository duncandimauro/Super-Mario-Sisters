...
bool is_directory(string path)
{
  ...
  // If having trouble finding the Assets directory,
  // replace the string literal with a full path name to the directory,
  // e.g., "C:/SuperMarioSisters/Assets" or "/Users/Name/SuperMarioSisters/Assets"
...
int main(int argc, char* argv[])
{
	...
	Game().run(argc, argv, gw, "Super Mario Sisters");
}
